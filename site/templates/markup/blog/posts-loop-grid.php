                       ...
                       if( count($post->thumbnail) > 0)
                       {
                        ...
                        echo "<div style='padding:10px 20px;'>";
                            ...
                            if($post->summary != '')
                            {
                                ...
                                $summary = truncate(strip_tags($post->summary), 250);
                            } else {
                                $summary = $bodyCopy;
                            }
                            echo $summary;
                            ...
                            echo "<div class='mg-t-md mg-b-sm'><a href='{$post->url}' class='btn btn-left btn-default'><i class='icon-right-4'></i> Read More</a></div>";
