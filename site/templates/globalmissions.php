...
<div class='section ' style='background-color:#efefef;'>
    <div class="container pd-t-md pd-b-lg ">
        <div class="row multi-columns-row ">
            <?php
            $posts =  $pages->find("parent=/ministries/global-missions/,  sort=sort, template=globalmission, limit=12");
            ...
            $t = new TemplateFile(wire('config')->paths->templates . 'markup/globalmissions/posts-loop-grid.php');
            $t->set('posts', $posts);
            $out = $t->render();
            echo $out;
            ?>
        ...
        <div class='container'  style="display: none;">
            <div class='row mg-t-lg mg-b-lg'>
                ...
                $data .= " <div class='col-md-8 col-md-offset-2 mg-b-sm2 '><h4 class='mg-b-sm2'>Filter by Topics</h4>";
                    ...
                    {
                    $blog_count = $pages->count("parent=/global-missions/,  category=$category, template=post");
                    if( $blog_count  > 0 ){
