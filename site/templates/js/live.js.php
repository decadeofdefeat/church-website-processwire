    ...
    $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
        ...
        if (str.indexOf("chat") > -1) {
            if ($('#chat-tab').find("iframe").length == 0) {
                $('#chat-tab').append('<iframe frameborder="0" allowtransparency="true" src="https://www.youtube.com/live_chat?v=<?php echo $page->youtube_id;?>&embed.domain=<?php $page->live_domain;?>" class="chat-iframe" style="padding:0px;margin:0px;width:100%;min-height: 645px;max-height: 700px;height: 100%;" ></iframe>');
            }
        }
    })
