      ...
      <div class="row multi-columns-row ">
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 first-in-row ">
          <div style='background-color:#ffffff;padding-bottom:10px;' class='serif serif-md'>
            ...
            <div style='padding:10px 20px;'>
              ...
              <div class='mg-t-md mg-b-sm'><a href='https://goo.gl/maps/SptKwMV1cgzbSdNJ8' target="_blank" class='mt-2 btn btn-outline-dark'> Get Directions</a></div>
            </div>
          </div>
        </div>
        ...
        <div style='background-color:#ffffff;padding-bottom:10px;' class='serif serif-md'>
          ...
          <div style='padding:10px 20px;'>
            ...
            <div class='clearfix'></div>
            <div class='mg-t-md mg-b-sm'><a href='#' class='btn btn-left btn-default'> Get Directions</a></div>
          </div>
        </div>
      </div>
